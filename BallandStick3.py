...
class Cell:  # generic cell class
    def __init__(self, gid, x, y, z, theta):
        ...
        self._spike_detector = h.NetCon(self.soma(0.5)._ref_v, None, sec=self.soma)  # netcon, source = soma, tgt = n/a
...
class Ring:
    ...
    def _create_cells(self, N, r):
        """create the cells that will make up the ring"""
        self.cells = []
        for i in range(N):
            theta = i * 2 * h.PI / N
...
plt.figure()  # compare to a sim with half the synaptic weight
